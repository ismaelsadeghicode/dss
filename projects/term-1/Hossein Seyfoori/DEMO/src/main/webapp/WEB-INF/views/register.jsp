    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="/registerCheck" method="post">
                <p style="color: orangered;">${exist}</p>
                <p style="color: orangered;">${used}</p>
                <div class="input-group mb-3">
                    <input type="text" name="username" class="form-control <c:if test="${exist !=null} ">border border-danger</c:if> " placeholder="نام کاربری">
                    <div class="input-group-append">
                        <span class="fa fa-envelope input-group-text"></span>
                    </div>
                </div>
                <div class="input-group mb-3">
                    <input type="email" name="email" class="form-control <c:if test="${exist !=null}">border border-danger</c:if>" placeholder="ایمیل">
                    <div class="input-group-append">
                        <span class="fa fa-envelope input-group-text"></span>
                    </div>
                </div>
